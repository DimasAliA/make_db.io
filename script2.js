...
modifyBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        const response = await fetch('https://e9f7-36-85-5-154.ngrok-free.ap/sql/modifySQLWithMaxTokens', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
document.getElementById('downloadSql').addEventListener('click', async () => {
    try {
        const response = await fetch('https://e9f7-36-85-5-154.ngrok-free.ap/sql/getSQLResult');
        const data = await response.json();
...
document.getElementById('logoutBtn').addEventListener('click', function() {
    fetch('https://e9f7-36-85-5-154.ngrok-free.ap/auth/logout', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
        }
